...
import { Package, Home, LogOut, Truck, Users, ChefHat, ClipboardList, BarChart, Thermometer, Camera, Menu, X, Calculator, CalendarDays, FileText, UserCog, LogOutIcon, Shield } from 'lucide-react';
